...
public class GoogleCalendarService {
    ...
    public GoogleCalendarCreateResponse createGoogleCalendar(
        ...
        if(googleApiResponse == null || googleApiResponse.id() == null) {
            throw new GoogleCalenderCreateFailed();
        }
    ...
    public void updateGoogleCalendar(UUID userId, GoogleCalendarUpdateRequest request) {
        ...
        GoogleCalendarApiResponse googleApiResponse = restClient.patch()
            .uri(GOOGLE_CALENDAR_EVENT_URL + "/{eventId}",
        ...
        if(googleApiResponse == null || googleApiResponse.id() == null) {
            throw new GoogleCalendarUpdateFailed();
        }
    }

    public void deleteGoogleCalendar(UUID userId, String googleEventId) {
        User user = userRepository.findById(userId).orElseThrow();
        ...
        restClient.delete()
            .uri(GOOGLE_CALENDAR_EVENT_URL + "/{eventId}", googleEventId)
            .headers(headers -> headers.setBearerAuth(accessToken))
            .retrieve()
            .toBodilessEntity();
    }
